...
class Quiz(TimeStampedMixin):
    ...
    is_random_question = models.BooleanField(
        default=False, verbose_name="문제 랜덤 배치"
    )
    is_random_choice = models.BooleanField(
        default=False, verbose_name="선택지 랜덤 배치"
    )
...
class QuizQuestion(TimeStampedMixin):
    quiz = models.ForeignKey(
        Quiz, on_delete=models.CASCADE, related_name="related_questions"
    )
    question = models.ForeignKey(
        Question, on_delete=models.CASCADE, related_name="related_quizzes"
    )
